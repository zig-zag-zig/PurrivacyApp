import type { Encryption, EncryptionBase, UserCreatePayload, UserEncrypted } from '../../types/types';
...
export function createUserApi(request: ApiRequestFn) {
  return {
    ...
    updateKeys(keys: EncryptionBase[]) {
      return request('/user/update-keys', 'POST', { keys }, true);
    },
